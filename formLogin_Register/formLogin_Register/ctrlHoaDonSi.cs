...
{
    public partial class ctrlHoaDonSi : UserControl
    {
        private static ctrlHoaDonSi _instance;
        ...
        public static ctrlHoaDonSi Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new ctrlHoaDonSi();
                return _instance;
            }
        }
        public ctrlHoaDonSi()
        ...
        private void ctrlHoaDonSi_Load(object sender, EventArgs e)
        {
        ...
        private void load_()
        {
            DataTable dtKH = dtBase.DataReader("select MaHDD, TenKH, TenNV, NgayDatHang, NgayGiaoHang, TongTien, TraNgay, NoLai, NoiGiaoHang from tblDatHang join tblKhachHang on tblDatHang.MaKH=tblKhachHang.MaKH join tblNhanVien on tblDatHang.MaNV=tblNhanVien.MaNV");
            ...
            dgvHD.Columns[3].HeaderText = "Ngày đặt";
            dgvHD.Columns[4].HeaderText = "Ngày giao";
            dgvHD.Columns[5].HeaderText = "Tổng tiền";
            dgvHD.Columns[6].HeaderText = "Trả ngay";
            dgvHD.Columns[7].HeaderText = "Nợ lại";
            dgvHD.Columns[8].HeaderText = "Nơi giao hàng";
        ...
        private void txtTimKiem_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                DataTable dtKH = dtBase.DataReader("select MaHDD, TenKH, TenNV, NgayDatHang, NgayGiaoHang, TongTien, TraNgay, NoLai, NoiGiaoHang from tblDatHang join tblKhachHang on tblDatHang.MaKH=tblKhachHang.MaKH join tblNhanVien on tblDatHang.MaNV=tblNhanVien.MaNV where MaHDD like N'%" + txtTimKiem.Text + "%' or TenKH like N'%" + txtTimKiem.Text + "%'");
                dgvHD.DataSource = dtKH;
                for (int i = 0; i < dgvHD.RowCount; i = i + 2)
                {
                    dgvHD.Rows[i].DefaultCellStyle.BackColor = Color.LightSkyBlue;
        ...
        private void dgvKH_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string[] ngaygiao;
            ngaygiao = dgvHD.Rows[numrow].Cells[4].Value.ToString().Trim().Split(' ');
            txtNgayGiao.Text = ngaygiao[0];

            txtTongTien.Text = dgvHD.Rows[numrow].Cells[5].Value.ToString().Trim();
            txtNoiGiao.Text = dgvHD.Rows[numrow].Cells[8].Value.ToString().Trim();
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
                ...
                exSheet.get_Range("E7").Value = "Ngày đặt";
                exSheet.get_Range("E7").ColumnWidth = 15;
                exSheet.get_Range("F7").Value = "Ngày giao";
                exSheet.get_Range("F7").ColumnWidth = 15;
                exSheet.get_Range("G7").Value = "Tổng tiền";
                exSheet.get_Range("G7").ColumnWidth = 10;
                exSheet.get_Range("H7").Value = "Trả ngay";
                exSheet.get_Range("H7").ColumnWidth = 10;
                exSheet.get_Range("I7").Value = "Nợ lại";
                exSheet.get_Range("I7").ColumnWidth = 10;
                exSheet.get_Range("J7").Value = "Nơi giao";
                exSheet.get_Range("J7").ColumnWidth = 25;
        ...
        {
            frmThem_HD_Si frmThem_hd = new frmThem_HD_Si();
            frmThem_hd.ShowDialog();
        }

        private void btnSua_Click(object sender, EventArgs e)
        {
            frmSuaHD_Si frmSua_hd = new frmSuaHD_Si();
            frmSua_hd.ShowDialog();
        }
    }
}
